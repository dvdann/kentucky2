...
module.exports = {
  ...
  execute(message, args, client) {
    ...
    message.reply(new MessageEmbed().setColor("RANDOM").setTitle(":heart: Please Invite me: ").setDescription("https://discord.com/oauth2/authorize?client_id=786803818389438484&permissions=0&scope=bot")
