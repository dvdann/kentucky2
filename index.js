...
client.on(`ready`, () => {	
   ...
   ///////////////////////////////
    ////////////IFCHEMPTY//////////
      ...
      client.user.setActivity(`Official Kentucky 2!`, { type: "PLAYING"});
...
client.on(`message`, async (message) => {
  ...
  if(message.content.includes(client.user.id)) {
    message.reply(new Discord.MessageEmbed().setColor("RANDOM").setDescription(`My prefix is \`k2!\``, message.author.displayAvatarURL({dynamic:true})));
  } 
